...
void setup()
{
  ...
  /*
   * UNCOMMENTE THESE LINES IN DEFINTIVE DEPLOY
  ...
  */
  ...
  // MPR 2 - 2 big pads
  mpr[0].cap.setFalling( 1, 4, 1, 1);
  mpr[0].cap.setRising(  1, 2, 1, 1);
  mpr[0].cap.setTouched( 8, 36, 36);
  mpr[0].cap.setThresholds( 12, 5 );

  /*
  // MPR 3 - 7 small pads
  mpr[3].cap.setFalling( 1, 4, 1, 1);
  mpr[3].cap.setRising(  4, 1, 2, 1);
  mpr[3].cap.setTouched( 8, 8, 8);
  mpr[3].cap.setThresholds( 24, 5 );
  */
